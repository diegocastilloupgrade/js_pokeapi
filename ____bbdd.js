...
for (const pokemon of pokemons) {
  ...
  const pokemonSpecie$$ = document.createElement('p');
  const pokemonOrder$$ = document.createElement('p');
  const pokemonType$$ = document.createElement('p');
  const pokemonWeight$$ = document.createElement('p');
  const pokemonHeight$$ = document.createElement('p');
  const pokemonAbilities$$ = document.createElement('p');
  const pokemonPicture$$ = document.createElement('img');
  const backgroundPicture$$ = pokemon.species.url;
  const nombreEstadio$$ = document.createElement('p');
  

  //Contenedor Pokemon
  pokemonItem$$.classList.add('divPokemon');
  console.log(pokemonItem$$);
  
  //Imagen de fondo del cromo
  pokemonItem$$.style.backgroundImage = 'url(' + backgroundPicture$$ + ')';
  pokemonItem$$.backgroundSize = 'cover';
  
  
  //nombre del pokemon
  pokemonName$$.innerText = pokemon.name;
  pokemonSpecie$$.innerText = pokemon.species;
...
//Estadio
nombreEstadio$$.innerText = pokemon.estadio;
nombreEstadio$$.classList.add('nombreEstadio');

  console.log(pokemonName$$);
  pokemonList$$.appendChild(pokemonItem$$);
  pokemonItem$$.appendChild(pokemonName$$);
  pokemonItem$$.appendChild(pokemonOrder$$);
  pokemonItem$$.appendChild(pokemonType$$)
  pokemonItem$$.appendChild(pokemonSpecie$$);
  pokemonItem$$.appendChild(pokemonHeight$$);
  pokemonItem$$.appendChild(pokemonWeight$$);
}